...
public class NovoUsuario {
    public static void main(String[] args) {
        ...
        /*
            A sequência típica de uso envolve criar uma única instância de EntityManagerFactory durante a inicialização do aplicativo,
            geralmente no momento da inicialização do contexto de aplicação.

            Depois, você cria instâncias de EntityManager a partir da fábrica sempre que precisar executar operações de persistência.
        ...
        // mas não precisa gerar o EntityManagerFactory que é gerado apenas 1 vez. CONFIRMAR ISSO!

        Usuario novoUsuario = new Usuario("Maria", "Maria@gmail.com.br");

        em.getTransaction().begin(); // Esta linha inicia uma nova transação
