...
public abstract class Mamifero extends Animal{
	...
	// isso tem efeito acumulativo, se uma classe abstrata 'extends' outra classe e por ai vai, cada uma criando um
	...
	// essa classe abstrata mamar parece com uma interface, vc aqui não implementa o corpo, ou seja
